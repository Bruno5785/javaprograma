...
public class calculaINSS {
	 ...
	 */ 
	 public static double calculaINSS( double base ) {  
		double aliquota  =  0 ;
		double valorINSS =  0 ;
		// incorporação o teto máximo de contribuição
		if (base >  6101.06 ) base =  6101.06 ;
		// encontra uma faixa de ir correspondente à base e guardar um alíquota
		...
		valorINSS =  Matemática . redondo (valorINSS * 100 ) /  100.0 ;
