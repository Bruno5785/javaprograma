...
public class TelaSaidas extends JFrame {
	...
	private void initComponents() {
		...
		lbSaidas.setForeground(Color.WHITE);
		lbSaidas.setFont(new Font("Tahoma", Font.PLAIN, 32));
		lbSaidas.setBounds(21, 11, 441, 39);
		pnTitulo.add(lbSaidas);
